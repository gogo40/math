...
$$
 z^2 \displaystyle \frac{d^2}{dz^2}Y - 2z \displaystyle \frac{d}{dz}Y = \mathcal{Z} \left\{ n^2  \right\} - 2 z  
 \displaystyle \frac{d}{dz}Y \mathcal{Z} \left\{u(n)\right\}
$$

$$
\begin{array}{lcl} 
 z^2 \displaystyle \frac{d^2}{dz^2}Y - 2z \displaystyle \frac{d}{dz}Y=\\ 
 \mathcal{Z} \left\{ n^2 \right\} - 2 z \left( \displaystyle \frac{1}{1 - z^{-1}} \right) \displaystyle \frac{d}{dz}Y \\
 z^2 \displaystyle \frac{d^2}{dz^2}Y - 2z \displaystyle \frac{d}{dz}Y = \mathcal{Z} \left\{ n^2  \right\} -  \left( \displaystyle \frac{2z}{z - 1} \right) \displaystyle \frac{d}{dz}Y
\end{array}  
$$
...
\begin{array}{lcl} 
z^2 \displaystyle \frac{d^2}{dz^2}Y - 2z \displaystyle \frac{d}{dz}Y =\\
\displaystyle\frac{z^{-1} (1 + z^{-1})}{(1 - z^{-1})^3} -  \left( \displaystyle \frac{2z}{z - 1} \right) \displaystyle \frac{d}{dz}Y \\

 z^2 \displaystyle \frac{d^2}{dz^2}Y - 2z \displaystyle \frac{d}{dz}Y  = \\
 \frac{z^2 (1 + z^{-1})}{(z - 1)^3} 
 -  \left( \displaystyle \frac{2z}{z - 1} \right) \displaystyle \frac{d}{dz}Y \\
 
 
 z^2 \displaystyle \frac{d^2}{dz^2}Y - 2z \displaystyle \frac{d}{dz}Y = \frac{z(z + 1)}{(z - 1)^3} + 
